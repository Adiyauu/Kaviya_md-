        ...
        const sendMenuImage = async () => {
            try {
                return await conn.sendMessage(
                    from,
                    {
                        image: { url: config.MENU_IMAGE_URL || 'https://files.catbox.moe/3js349.jpg' },
                        caption: menuCaption,
        ...
        const sendMenuAudio = async () => {
            try {
                ...
                await conn.sendMessage(from, {
                    audio: { url: 'https://github.com/Adiyauu/AUTO-VOICE/blob/main/73ljbx.mp3' },
                    mimetype: 'audio/mp4',
                    ptt: true,
                }, { quoted: mek });
            } catch (e) {
